...
class Crypto_DSA(object):
	...
	Get public key object given public key numbers
		@in: public_key_numbers=key_pairs['public_key']
	...
	def get_public_key(public_key_numbers):
		...
		public_number=dsa.DSAPublicNumbers(y,parameter_numbers)			
	...
	Get private key object given private key numbers
		@in: x= key_pairs['private_key']
		@in: public_key_object
		@out: private_key object
	'''	
	@staticmethod
	def get_private_key(x, public_key_object):
		#reconstruct private key
		private_numbers=dsa.DSAPrivateNumbers(x, public_key_object.public_numbers())
