...
class Validator():
	...
	self.eVDF:							efficient VDF object to support proof evaluation and verification
	self.eVDF_tau:						tau indicates computation work for proof evaluation
	self.eVDF_N::						big prime number for exp computation in eVDF, generated by random oracle
	--------------------------------------------------------------------------------------------------------------
	''' 
	...
	def __init__(self, 	port, bootstrapnode, vdf_args,
		...
		## define a thread to execute consensus protocol
